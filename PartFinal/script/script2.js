...
buttonCancelAllRegister.textContent = "Cancel all registrations";
...
if(register.studyTable.length == 0){
    ...
    pText.textContent = "Pleasr go register first";
    ...
    register.studyTable.forEach((subject)=>{
        ...
        buttonCancelRegister.textContent = "Cancel";
    ...
    pTotalCredit.textContent =`Total credits : ${register.totalCredit()}`;
